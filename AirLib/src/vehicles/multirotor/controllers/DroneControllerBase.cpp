...
// rotate camera in pitch and yaw -- amigo
bool DroneControllerBase::rotateCameraBySpeed(int cam_id, float v_roll, float v_pitch, float v_yaw, float duration, CancelableBase& cancelable_action)
{
	if (duration <= 0)
		return true;

	commandCameraRotate(v_roll, v_pitch, v_yaw);
