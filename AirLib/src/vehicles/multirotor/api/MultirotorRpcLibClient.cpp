...
bool MultirotorRpcLibClient::rotateCameraBySpeed(int cam_id, float v_roll, float v_pitch, float v_yaw, float duration)// gimbal api -- amigo
{
	return static_cast<rpc::client*>(getClient())->call("rotateCameraBySpeed", cam_id, v_roll, v_pitch, v_yaw, duration).as<bool>();
}
